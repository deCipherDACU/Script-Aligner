...
import { X, FileText, Wand2, Download, Keyboard, AlertTriangle, Shield, Globe, Database, Zap } from 'lucide-react';
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-[#333] bg-[#222]">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Features & Workflow</p>
          </div>
          <button
            onClick={onClose}
